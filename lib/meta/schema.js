...
* @returns {Object}
*/
function newMusicRecording(name, composition, byArtist, duration, isrc, audio) {
  return {
    '@context': SCHEMA,
    '@type': 'MusicRecording',
    name: name,
...
* @returns {Object}
*/
function newMusicAlbum(name, tracks, albumProductionType, releaseType, byArtist) {
  return {
    '@context': SCHEMA,
    '@type': 'MusicAlbum',
    name: name,
...
* @returns {Object}
*/
function newMusicRelease(catalogNumber, duration, musicReleaseFormat, recordLabel, releaseOf) {
  return {
    '@context': SCHEMA,
    '@type': 'MusicRelease',
