...
* @returns {Object}
*/
function newMusicPlaylist(tracks, image) {
  return {
    '@context': SCHEMA,
    '@type': 'MusicPlaylist',
    tracks: tracks,
...
* @returns {Object}
*/
function newMusicAlbum(name, tracks, albumProductionType, releaseType, byArtist, image) {
  return {
    '@context': SCHEMA,
    '@type': 'MusicAlbum',
    name: name,
...
* @returns {Object}
*/
function newMusicRelease(catalogNumber, duration, musicReleaseFormat, recordLabel, releaseOf, image) {
  return {
    '@context': SCHEMA,
    '@type': 'MusicRelease',
